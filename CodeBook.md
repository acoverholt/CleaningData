...
* Other variables - other variables are given as measurements given in the dataset averaged over subject and activity. The names of these measurements are explained in this exerpt from the features_info.txt file accompaning the dataset:
...
Information on UCI HAR Dataset as taken from the README included with the data:
